...
handler.command = handler.help = ['ahegao', 'ass', 'bdsm', 'blowjob', 'cuckold', 'cum', 'ero', 'foot', 'gangbang', 'glasses', 'hentai', 'gifs', 'jahy', 'manga', 'masturbation', 'neko', 'neko2', 'orgy', 'tentacles', 'pussy', 'panties', 'thighs', 'yuri', 'zettai', 'cosplay']
handler.tags = ['nsfw']
handler.limit = true;
